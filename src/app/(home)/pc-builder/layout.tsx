...
export default async function DashboardLayout({
  ...
  return (
    <div className="container mx-auto mt-16 lg:flex lg:items-start lg:gap-8 lg:border lg:p-10">
      ...
      <aside className="flex min-w-0 flex-col gap-6 uppercase lg:flex-3">
        <BuilderSummary />
      </aside>
    </div>
  )
