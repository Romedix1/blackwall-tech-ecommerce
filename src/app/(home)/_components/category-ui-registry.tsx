...
const CARD_IMAGE_CLASS = 'z-30 absolute -right-[20%] xl:w-[650px] -bottom-[4%]'

export const CATEGORY_UI_REGISTRY: Record<
  string,
  { className?: string; image: ReactNode }
> = {
  gpu: {
    ...
    image: (
      <div className="relative aspect-4/3 rotate-8">
        <Image
          src={GraphicCard}
          alt="Graphic card"
          className={cn(CARD_IMAGE_CLASS, 'w-full rotate-355 xl:w-225')}
          width={1600}
          height={1200}
    ...
    image: (
      <div className="relative aspect-4/3 rotate-8">
        <Image
          src={Processor}
          alt="Processor"
          className={cn(CARD_IMAGE_CLASS, 'top-[5%] w-full scale-125')}
          width={1200}
          height={1000}
